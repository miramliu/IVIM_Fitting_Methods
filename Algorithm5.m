...
function Output = Algorithm5(bvalues, signal)
...
%}
    ...
    try
        [fitmod_bi,good_bi,~]=fit(bvalues,signal(:)/signal(1),ft_bi,'startpoint',fo_bi, 'problem', {D_fit, f_fit}); %no longer in log space
        Output.D=D_fit;
